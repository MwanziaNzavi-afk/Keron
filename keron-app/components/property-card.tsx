    ...
    >
      ...
      <div className="p-7">
        ...
        <div className="mt-7 flex items-center justify-between gap-4">
          ...
          <Link
            href={href}
            className="inline-flex items-center justify-center rounded-full bg-[#041d52] px-5 py-3 text-sm font-semibold text-white shadow-[0_12px_42px_rgba(4,29,82,0.24)] transition duration-200 hover:-translate-y-0.5 hover:bg-[#07256b] hover:shadow-[0_16px_48px_rgba(4,29,82,0.32)] focus:outline-none focus:ring-2 focus:ring-[#d4af37] focus:ring-offset-2"
          >
            View Details
          </Link>
        </div>
